...
scripts/strip-image \
	...
	-f /usr/share/maven/ \
	-f /usr/src/mymaven/
docker run -it -p 3330:3330 --cap-drop=all --security-opt seccomp=policies/seccomp.json --name priote_c -v "${PWD}/data":/usr/src/mymaven/data:rw priote_stripped_i:latest
